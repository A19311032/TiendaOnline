    ...
    <table class="tg center">
        <thead>
            <tr>
                ...
                <th class="tg-h2g2">Descripcion</th>
                <th class="tg-h2g2">Categoria</th>
                <th class="tg-h2g2">Proveedor</th>
                <th class="tg-h2g2">Cantidad</th>
                <th class="tg-h2g2">Precio</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            <tr>
                ...
                <td class="tg-i81m">{{$item->description}}</td>
                <td class="tg-i81m">{{$item->category_id}}</td>
                <td class="tg-i81m">{{$item->user_id}}</td>
                <td class="tg-i81m">{{$item->stock}}</td>
                <td class="tg-i81m">{{$item->price}}</td>
